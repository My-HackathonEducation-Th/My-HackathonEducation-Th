...
**หน้าจอแสดงผล สำหรับ ที่เก็บของคุณเเล้ว**  
...
**เลือก เมนู อัพโหลดไฟล์ ที่ต้องการ.. หากต้องการเข้าถึงทุกพื้นที่ อัพโหลดระยะไกล ให้ใช้การกระทำเเบบ git add .**

### ฉันคือคนไทย ตัวเลือกการ commit เเบบไทย 
...
**นั้นละครับท่านผู้ชม สรุปคือ คุณไม่จำเป็น ต้อง "ดาวน์โหลดโปรแกรม IDE เพื่อมาเขียนโค๊ด  html css javascript ไหนจะตั้งค่าต่างๆ วุ่นวาย deployment เว็บไซต์ การจดทะเบียนที่ไหนว้า.. โดเมนคือ? การเช่าโฮลดิ้งรายเดือนรายปีแบบไหนคุ้ม เเละอื่นๆ" ลบความคิดเดิมๆ เพราะว่าสิ่งนี่ ตรงนี้ฟรี!หรือ ต้องการขั้นสูงกว่า เช่น React , Vue ฉันอยากมีเวบไชต์ที่ตอบสนอง การเเสดงผล ทั้ง Laptop,มือถือ เเบบ React , Vue เเบบหรูๆ ก็ลอง ค้นหาเครื่องมือ สร้างเว็บไซต์แบบลากและวางโอเพ่นซอร์สโดยใช้ React
              CMS  React , Vue, Svelte, Qwik และอีกมากมาย - GitHub - Build-React , Vue หากเป็นประโยขน์เนอะ ต้องการจะดาวน์โหลด ไฟล์ ไปอ่านเล่นๆ หรือเรียนรู้เพิ่ม เอาไปสร้างของท่านเอง ก็ไปที่**
